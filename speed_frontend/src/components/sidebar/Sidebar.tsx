  ...
  return (
    <aside className="bg-gray-800 text-white w-64 min-h-screen p-4">
      ...
      <nav className="space-y-2">
        ...
        <NavItem href="/articles" icon={FaNewspaper}>
          Articles
        </NavItem>
        <NavItem href="/submit" icon={FaUpload}>
          Submit
        </NavItem>
        <NavItem href="/show-moderation" icon={FaUserCog}>
          Moderate
        </NavItem>
        <NavItem href="/analyze" icon={FaDatabase}>
          Analyze
        </NavItem>
        <NavItem href="/admin" icon={FaUserCog}>
          Admin
        </NavItem>
      </nav>
